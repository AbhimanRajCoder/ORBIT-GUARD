...
export default function Error({
  ...
  return (
    <div className="h-[calc(100vh-100px)] w-full flex items-center justify-center select-none">
      <div className="max-w-md w-full bg-[#0c1222]/80 border border-collision-red/30 rounded-[8px] p-8 text-center space-y-5 animate-in slide-in-from-bottom-4">
        ...
        <div className="bg-[#0a0e1a] border border-iron/50 rounded-[4px] p-3 text-left overflow-hidden">
